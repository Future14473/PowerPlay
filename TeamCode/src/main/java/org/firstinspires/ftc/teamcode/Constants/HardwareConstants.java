...
//  slides
    ...
    //   claw
    public static double OUT_POS_CLAW = 0.1;
...
//   v4b
    ...
    public static double OUT_V4B = 0.75;
...
//  intake timings
    public static long TURRET_HOME = 1000;
    public static long V4B_HOME = 1000;
    public static long SLIDES_HOME = 2000;

    public static long TURRET_OUT = 800;
    public static long SLIDES_OUT = 800;
