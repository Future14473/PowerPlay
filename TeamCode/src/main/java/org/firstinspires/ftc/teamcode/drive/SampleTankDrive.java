...
import org.firstinspires.ftc.teamcode.drive.opmode.util.DashboardUtil;
import org.firstinspires.ftc.teamcode.drive.opmode.util.LynxModuleUtil;
...
//        follower = new ImprovedRamsete();
        follower = new RamseteFollower(68, 69);
    ...
    public void turnToDuckCollect(double angle, ServoTurret turret){
        Pose2d currentPose = getPoseEstimate();
        turnAngle = angle - currentPose.getHeading();
...
//    }
    ...
    public void followTrajectoryAsyncTaskBreakBlock(Trajectory trajectory, ServoTurret turret, Runnable asyncMethod){
        followTrajectoryAsync(trajectory);
        asyncMethod.run();
        waitForIdleOrBlock(turret);
    }
    public void followTrajectoryBreakBlock(Trajectory trajectory, ServoTurret turret){
        followTrajectoryAsync(trajectory);
        waitForIdleOrBlock(turret);
    }
    ...
    public void waitForIdleOrBlock(ServoTurret turret){
