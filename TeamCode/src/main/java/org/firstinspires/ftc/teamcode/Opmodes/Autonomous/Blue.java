...
public class Blue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence moveToPolePreload = drive.trajectorySequenceBuilder(blueAllianceBlueStation)
                .lineToLinearHeading(new Pose2d(-44,15, Math.toRadians(-45)))
                .lineTo(new Vector2d(-22,13))
                .addDisplacementMarker(preloadReady, () -> {
                    intakeWheels.outtake();
                    slides.extendHigh();
                })
                .addDisplacementMarker(preloadReady+30, () -> {
                    intakeWheels.idle();
                })
                .build();
        ...
        TrajectorySequence moveToStack = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-58.2, 13, Math.toRadians(0)))
                .addDisplacementMarker(10, () -> {
                    v4b.setCustom(0.7);
                })
                .addDisplacementMarker(13, () -> {
                    claw.setCustom(OUT_POS_CLAW + 0.1);
                })
                .build();
        ...
        TrajectorySequence moveToMidPole = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-24,23, Math.toRadians(45)))
                .addDisplacementMarker(10, () -> {
                    slides.extendMid();
                })
                .build();
        ...
        TrajectorySequence moveToStack2 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-58.2, 18, Math.toRadians(0)))
                .addDisplacementMarker(10, () -> {
                    v4b.setCustom(0.7);
                })
                .addDisplacementMarker(13, () -> {
        ...
        TrajectorySequence moveToMidPole2 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-25.5,19.5, Math.toRadians(225)))
                .addDisplacementMarker(10, () -> {
                    slides.extendMid();
                })
                .build();
